...
- [ ] Create and revise reviewable PowerShell scripts; validate and open a dedicated PR.
...
Each feature uses one commit and a stacked PR assigned to the repository owner.
